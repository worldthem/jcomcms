package ecommercejava.cms.icommyjava.paymentmethods.banktransfer;
...
public class BankTransferModule {
    ...
    public String getDescription() {
        return description==null?  "Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account." : Language.getLangData(description);
    }
